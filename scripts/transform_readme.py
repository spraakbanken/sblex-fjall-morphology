...
def main(target: str) -> None:
    ...
    for existing, replacement in [
        (
            "https://img.shields.io/pypi/v/sblex-fjall-morphology.svg",
            f"https://img.shields.io/pypi/v/sblex-fjall-morphology/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/l/sblex-fjall-morphology.svg",
            f"https://img.shields.io/pypi/l/sblex-fjall-morphology/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/pyversions/sblex-fjall-morphology.svg",
            f"https://img.shields.io/pypi/pyversions/sblex-fjall-morphology/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/status/sblex-fjall-morphology.svg",
            f"https://img.shields.io/pypi/status/sblex-fjall-morphology/{version}.svg",
        ),
    ]:
    ...
    def replace(match: re.Match) -> str:
        ...
        if not url.startswith("http"):
            url = urllib.parse.urljoin(
                f"https://github.com/spraakbanken/sblex-fjall-morphology/blob/{version}/README.md",
                url,
            )
        return f"]({url})"
